            ...
            children: [
              ...
              Card(
                ...
                child: ListTile(
                  ...
                  title:
                      Text(profile.cell!, style: const TextStyle(fontSize: 18)),
                ),
              ),
              Card(
                color: Colors.white,
                ...
                child: ListTile(
                  ...
                  title:
                      Text(profile.nat!, style: const TextStyle(fontSize: 18)),
                ),
              ),
              Card(
                  color: Colors.white,
                  ...
                  child: ExpansionTile(
                    ...
                    children: [
                      ListTile(
                        ...
                        title: Text(profile.location!.country!,
                            style: const TextStyle(fontSize: 18)),
                      ),
                      ListTile(
                        leading: const Text('State: '),
                        title: Text(profile.location!.state!,
                            style: const TextStyle(fontSize: 18)),
                      ),
                      ListTile(
                        leading: const Text('City: '),
                        title: Text(profile.location!.city!,
                            style: const TextStyle(fontSize: 18)),
                      ),
                      ExpansionTile(
                        ...
                        children: [
                          ListTile(
                            ...
                            title: Text(profile.location!.street!.name!,
                                style: const TextStyle(fontSize: 18)),
                          ),
                          ListTile(
                            leading: const Text('Number: '),
                            title: Text(
                                profile.location!.street!.number!.toString(),
                                style: const TextStyle(fontSize: 18)),
                          ),
                        ],
                      ),
                      ListTile(
                        ...
                        title: Text(profile.location!.postcode!,
                            style: const TextStyle(fontSize: 18)),
                      ),
                      ExpansionTile(
                      ...
                      ExpansionTile(
                        ...
                        children: [
                          ListTile(
                            ...
                            title: Text(profile.location!.timezone!.offset!,
                                style: const TextStyle(fontSize: 18)),
                          ),
                          ListTile(
                            leading: const Text('Description: '),
                            title: Text(
                                profile.location!.timezone!.description!,
                                style: const TextStyle(fontSize: 18)),
                          ),
                        ],
                      ),
              ...
              Card(
                  ...
                  child: ExpansionTile(
                    ...
                    children: [
                      ListTile(
                        leading: const Icon(Icons.person),
                        title: Text(profile.login!.username!,
                            style: const TextStyle(fontSize: 18)),
                      ),
                      ListTile(
                        leading: const Icon(Icons.lock),
                        title: Text(profile.login!.password!,
                            style: const TextStyle(fontSize: 18)),
                      ),
                    ],
                  )),
