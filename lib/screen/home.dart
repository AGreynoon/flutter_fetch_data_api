...
import 'package:flutter_fetch_data_api/screen/profile.dart';
import 'package:flutter_fetch_data_api/services/user_api.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          title:
              !searchBoolean ? const Text('Rest Api Call') : searchTextField(),
          centerTitle: true,
                ...
                return ListTile(
                  ...
                  onTap: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => UserProfile(profile: user)));
                  },
                );
              }),
        ),
